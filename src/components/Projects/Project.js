        ...
        <div id="projects">
            <div className={styles.projects}>
                ...
                <section className={styles.projectHeader}>
                    ...
                    <div>My works makes use of vast variety of latest technology tools. My best experience is to create Frontend projects and deploy them to web applications using Github Pages.</div>
                </section>
            </div>
            <ProgrammingSkills />
