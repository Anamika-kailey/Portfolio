...
import { HTML, CSS, JavaScript, ReactJs,  CPP, Java, mySQL } from "../asset/svg/svg";
import { useSelector } from "react-redux";
const skills = [HTML, CSS, JavaScript, ReactJs,  CPP, Java, mySQL];
const skillNames=["HTML","CSS","JavaScript","ReactJs","CPP","Java","mySQL"];
